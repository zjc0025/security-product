...
!function (n) {
    ...
    t(1);
    var o = 310, s = 155, a = 42, c = 9, l = Math.PI, u = a + 2 * c + 3;
    ...
    var m = function () {
        function n(e) {
            var t = e.el, i = e.width, a = void 0 === i ? 310 : i, c = e.height, l = void 0 === c ? 155 : c,
                u = e.onSuccess, d = e.onFail, f = e.onRefresh;
            !function (n, e) {
        ...
        return i(n, [{
            ...
            key: "initDOM", value: function () {
                ...
                }(o, s), e = n.cloneNode(!0), t = f("div", "sliderContainer");
                t.style.width = o + "px";
                var i = f("div", "refreshIcon"), a = f("div", "sliderMask"), c = f("div", "slider"),
                    l = f("span", "sliderIcon"), u = f("span", "sliderText");
                e.className = "block", u.innerHTML = "向右滑动填充拼图";
                var d = this.el;
                d.appendChild(n), d.appendChild(i), d.appendChild(e), c.appendChild(l), a.appendChild(c), t.appendChild(a), t.appendChild(u), d.appendChild(t), r(this, {
                    canvas: n,
                    block: e,
                    sliderContainer: t,
                    refreshIcon: i,
            ...
            key: "initImg", value: function () {
                var n = this, e = function (n) {
                    ...
                    var t = n.y - 2 * c - 1, r = n.blockCtx.getImageData(n.x - 3, t, u, u);
            ...
            key: "bindEvents", value: function () {
                ...
                var e = void 0, t = void 0, r = [], i = !1, s = function (n) {
                    e = n.clientX || n.touches[0].clientX, t = n.clientY || n.touches[0].clientY, i = !0
                }, a = function (s) {
                    if (!i) return !1;
                    var a = s.clientX || s.touches[0].clientX, c = s.clientY || s.touches[0].clientY, l = a - e,
                        u = c - t;
            ...
            key: "verify", value: function () {
                var n = this.trail, e = n.reduce(b) / n.length, t = n.map(function (n) {
                    return n - e
                }), r = Math.sqrt(t.map(g).reduce(b) / n.length), i = parseInt(this.block.style.left);
